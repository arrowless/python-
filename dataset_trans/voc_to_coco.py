...
def convert(xml_list, json_file):
    ...
    for index, line in enumerate(xml_list):
        ...
        image_id = id_cnt  # filename.split('.')[0][-3:]
...
if __name__ == '__main__':
    # xml标注文件夹
    xml_dir = '/Users/arrow/数据集/RSOD-split/aircraft/Annotation/xml'
    # 训练数据的josn文件
    save_json_train = './coco_data/train.json'
    # 验证数据的josn文件
    save_json_val = './coco_data/val.json'
    # 验证数据的test文件
    save_json_test = './coco_data/test.json'
