...
def deal(path):
    ...
    outpath = "/Users/arrow/数据集/NWPUVHR-10dataset/Annotations/"
    # 如果输出文件夹不存在，就创建它
    ...
    for file in files:
        ...
        if sufix == '.txt':  # 标注txt文件中每一行代表一个目标，(x1,y1)，(x2,y2)，class_number来表示
            ...
            imagepath = "/Users/arrow/数据集/NWPUVHR-10dataset/JPEGImages/" + filename_fill + ".jpg"
...
if __name__ == "__main__":
    ...
    old_path = "/Users/arrow/数据集/NWPUVHR-10dataset/positiveimageset/"
    new_path = "/Users/arrow/数据集/NWPUVHR-10dataset/JPEGImages/"
    ...
    path = "/Users/arrow/数据集/NWPUVHR-10dataset/ground_truth"
    deal(path)
